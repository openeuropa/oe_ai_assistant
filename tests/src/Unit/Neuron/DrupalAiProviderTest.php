...
use Drupal\oe_ai_assistant\Neuron\DrupalAiProvider;
 ...
 *
 * @coversDefaultClass \Drupal\oe_ai_assistant\Neuron\DrupalAiProvider
 */
class DrupalAiProviderTest extends TestCase {
  ...
  /**
   * @covers \Drupal\oe_ai_assistant\Neuron\DrupalAiMessageMapper::map
   */
