 ...
 * All responses use 200 (RPC convention).
 *
 * Data is stored in memory. Restarting the server resets to
 * seeded sample data. Responses are delayed 200-500ms to
...
/** Random delay between 200-500ms to simulate latency. */
...
notesRouter.post("/get", async (req, res) => {
